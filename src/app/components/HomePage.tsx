...
const CARDS = [
  ...
  },
  {
    ...
    titleAr: 'القصر',
    badge: '3D GLTF',
    desc: 'Walk through the Sponza Palace — a real 3D architectural model with PBR materials, columns, arched ceilings, and atmospheric lighting. Navigate entirely with your hands.',
    descAr: 'تجوّل داخل قصر سبونزا ثلاثي الأبعاد الحقيقي بإيماءات يدك',
    accent: '#fb923c',
    glow: 'rgba(251,146,60,0.16)',
    border: 'rgba(251,146,60,0.32)',
    features: ['Sponza GLTF', 'PBR lighting', 'Hand nav', 'First person'],
  },
  {
    id: 'docs',
    icon: '📖',
